...
#define FST_INTLIT 4, \
    FST::NODE(2,FST::RELATION('P', 1), FST::RELATION('N', 1)),\
    FST::NODE(19,	\
	FST::RELATION('1', 2), FST::RELATION('2', 2), FST::RELATION('3', 2), FST::RELATION('4', 2), FST::RELATION('5', 2), FST::RELATION('6', 2),\
	FST::RELATION('7', 2), FST::RELATION('8', 2), FST::RELATION('9', 2), FST::RELATION('0', 3),\
	\
...
#define FST_INTLITOCT 5,	\
	FST::NODE(2,FST::RELATION('P', 1), FST::RELATION('N', 1)),\
	FST::NODE(1, FST::RELATION('O', 2)),\
	FST::NODE(15,	\
	FST::RELATION('1', 3), FST::RELATION('2', 3), FST::RELATION('3', 3), FST::RELATION('4', 3), FST::RELATION('5', 3),FST::RELATION('6', 3),FST::RELATION('7', 3),FST::RELATION('0', 4),FST::RELATION('1', 4),FST::RELATION('2', 4),FST::RELATION('3', 4),FST::RELATION('4', 4),FST::RELATION('5', 4),FST::RELATION('6', 4),FST::RELATION('7', 4)),\
    FST::NODE(16,	\
	FST::RELATION('1', 3), FST::RELATION('2', 3), FST::RELATION('3', 3), FST::RELATION('4', 3), FST::RELATION('5', 3), FST::RELATION('6', 3),FST::RELATION('7', 3), FST::RELATION('0', 3),\
	FST::RELATION('1', 4), FST::RELATION('2', 4), FST::RELATION('3', 4), FST::RELATION('4', 4), FST::RELATION('5', 4), FST::RELATION('6', 4),FST::RELATION('7', 4),FST::RELATION('0', 4)),\
	\
	FST::NODE()
#pragma endregion
...
#define FST_CHARIT 4,	\
	...
	FST::NODE(152, \
			...
			FST::RELATION('ч', 2), FST::RELATION('ш', 2), FST::RELATION('щ', 2), FST::RELATION('ь', 2),\
			FST::RELATION('ы', 2), FST::RELATION('ъ', 2), FST::RELATION('э', 2), FST::RELATION('ю', 2),\
			FST::RELATION('я', 2),\
			FST::RELATION('А', 2), FST::RELATION('Б', 2), FST::RELATION('В', 2), FST::RELATION('Г', 2),\
			FST::RELATION('Д', 2), FST::RELATION('Е', 2), FST::RELATION('Ё', 2), FST::RELATION('Ж', 2),\
			FST::RELATION('З', 2), FST::RELATION('И', 2), FST::RELATION('Й', 2), FST::RELATION('К', 2),\
